  ...
  return (
    <div className="space-y-6 print:hidden pb-20 md:pb-0">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-ada-900">Mis Gemas</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {gems.map(gem => (
           <div key={gem.id} className="bg-ada-800 text-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 relative group min-h-[200px] flex flex-col">
              <div className="h-32 bg-gradient-to-br from-ada-600 to-ada-900 flex items-center justify-center relative p-4">
              ...
              <div className="p-4 flex-1 flex flex-col justify-between bg-ada-800">
